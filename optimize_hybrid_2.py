...
def simulate_keff(params):
    ...
    # --- Start of Integrated OpenMC Logic ---
...
# --- SEARCH SPACE TO FIND A HYBRID SOLUTION ---
search_space = [
    Real(0.001, 0.02, name='gadolinium_conc'),  # Force Gd to be at least 0.1%
    Real(0.001, 0.02, name='boron_conc')       # Force B to be at least 0.1%
]
...
best_keff = np.sqrt(result.fun) + 0.95
